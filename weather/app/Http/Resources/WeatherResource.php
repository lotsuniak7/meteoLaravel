...
/**
 * API Resource for formatting current weather data
 * This class takes the raw, complex payload from the OpenWeather API
 * and transforms it into a clean, structured JSON response for our own API
 */
